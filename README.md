...
- เปิด **บัญชี Nexus / ซิงก์ข้อมูล** ใช้อีเมล/รหัสผ่านเดิมและ TOTP ถ้าเปิด MFA ไว้ สมัคร/กู้คืนรหัสผ่านที่ [Nexus หลัก](https://nexus-lemon-eight-32.vercel.app)
...
- Nexus หลักมีลิงก์ Tools ทั้งเมนูเดสก์ท็อปและมือถือ; Tools มีลิงก์กลับ ไม่ส่ง access token ผ่าน URL
...
- ซิงก์อัตโนมัติและส่งต่อเซสชัน SSO ข้ามโดเมน (ปัจจุบันใช้บัญชีเดียวกัน แต่เข้าสู่ระบบแยกโดเมน)
